...
class WebController extends Controller
{
    public function home(){
        ...
        // }else{
            $tools          = Tool::where('home',0)->whereNull('tool_id')->where('status', 1)->orderByRaw("FIELD(title, 'Ti 84 calculator', 'Ti-30xs Calculator Online', 'online graphing calculator')")->get();
