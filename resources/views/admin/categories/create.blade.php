    ...
    <form action="{{ route('admin.categories.store') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-2xl grid grid-cols-1 gap-4 p-4">
        ...
        <div class="grid md:grid-cols-2 gap-4">
            ...
            <div class="">
                ...
                <input type="text" name="name" id="name" required class="bg-white text-sm py-1 border-[#E5E7EB] w-full rounded-md px-2 ring-gray-500 focus:ring-sky-600 focus:outline-none focus:border-sky-600">
            </div>

            <!-- Slug -->
            <div class="">
                <label for="slug" class="text-[#808191] mb-1 text-sm block">Slug</label>
                <input type="text" name="slug" id="slug" class="bg-white text-sm py-1 border-[#E5E7EB] w-full rounded-md px-2 ring-gray-500 focus:ring-sky-600 focus:outline-none focus:border-sky-600" readonly>
            </div>
            ...
            <div class="">
                ...
                <input type="text" name="meta_title" id="meta_title" class="bg-white text-sm py-1 border-[#E5E7EB] w-full rounded-md px-2 ring-gray-500 focus:ring-sky-600 focus:outline-none focus:border-sky-600">
            </div>

            <!-- Meta Keywords -->
            <div class="">
                <label for="meta_keywords" class="text-[#808191] mb-1 text-sm block">Meta Keywords (comma separated)</label>
                <input type="text" name="meta_keywords" id="meta_keywords" class="bg-white text-sm py-1 border-[#E5E7EB] w-full rounded-md px-2 ring-gray-500 focus:ring-sky-600 focus:outline-none focus:border-sky-600">
            </div>

            <!-- Meta Description -->
            <div class="md:col-span-2">
                <label for="meta_description" class="text-[#808191] mb-1 text-sm block">Meta Description</label>
                <textarea name="meta_description" id="meta_description" rows="3" class="bg-white text-sm py-1 border-[#E5E7EB] w-full rounded-md px-2 ring-gray-500 focus:ring-sky-600 focus:outline-none focus:border-sky-600"></textarea>
            </div>

            <!-- Description -->
            <div class="md:col-span-2">
                <label for="description" class="text-[#808191] mb-1 text-sm block">Category Description</label>
                <textarea name="description" id="description" rows="3" class="bg-white text-sm py-1 border-[#E5E7EB] w-full rounded-md px-2 ring-gray-500 focus:ring-sky-600 focus:outline-none focus:border-sky-600"></textarea>
            </div>

            <!-- Active / Inactive -->
            <div class="flex justify-between col-span-2">
                <div class="flex items-center gap-2 md:col-span-2 mt-2">
                    <input type="checkbox" name="is_active" id="is_active" value="1" class="rounded border-gray-300 text-sky-600 focus:ring-sky-600">
