        ...
        <div class="grid grid-cols-12 gap-4">
            <div class="bg-white rounded-2xl col-span-9 p-4">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="content" id="post_content" rows="4" class="bg-gray-200 text-sm py-1 border-gray-300 w-full rounded-md px-2 ring-gray-500 focus:ring-sky-600 focus:outline-none focus:border-sky-600">{{ $post->content }}</textarea>
                </div>
                <div class="mb-4">
