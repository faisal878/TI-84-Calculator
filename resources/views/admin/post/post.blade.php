...
@section('content')
    <form action="{{ route('admin.blog.store') }}" method="POST" enctype="multipart/form-data" class="pr-3">
        @csrf
        ...
        <div class="grid grid-cols-12 gap-4">
            <div class="bg-white rounded-2xl col-span-9 p-4">
                <div class="mb-4">
                    ...
                    <input type="text" name="name" id="name" class="bg-gray-200 text-sm py-1 border-gray-300 w-full rounded-md px-2 ring-gray-500 focus:ring-sky-600 focus:outline-none focus:border-sky-600" required>
                </div>
                <div class="mb-4">
                    <label for="slug" class="text-[#808191] mb-1 text-sm block">Slug</label>
                    <input type="text" name="slug" id="slug" class="bg-gray-200 text-sm py-1 border-gray-300 w-full rounded-md px-2 ring-gray-500 focus:ring-sky-600 focus:outline-none focus:border-sky-600">
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="meta_keywords" id="meta_keywords" class="bg-gray-200 text-sm py-1 border-gray-300 w-full rounded-md px-2 ring-gray-500 focus:ring-sky-600 focus:outline-none focus:border-sky-600">
                </div>
                <div class="mb-4">
                    <label for="slug" class="text-[#808191] mb-1 text-sm block">Excerpt</label>
                    <textarea name="description" id="description" rows="2" class="bg-gray-200 text-sm py-1 border-gray-300 w-full rounded-md px-2 ring-gray-500 focus:ring-sky-600 focus:outline-none focus:border-sky-600"></textarea>
                </div>
                <div class="mb-4">
                    <label for="meta_description" class="text-[#808191] mb-1 text-sm block">Meta Description <span class="text-red-600">*</span></label>
                    <textarea name="meta_description" id="meta_description" rows="2" class="bg-gray-200 text-sm py-1 border-gray-300 w-full rounded-md px-2 ring-gray-500 focus:ring-sky-600 focus:outline-none focus:border-sky-600" required></textarea>
                </div>
            </div>
