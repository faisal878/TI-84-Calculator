...
<section class="lg:px-0 px-[15px]">
    <div class="max-w-[1240px] m-auto text-center relative py-16 overflow-hidden">
        <h1 class="font-bold mb-6 max-w-[940px] m-auto leading-tight lg:text-[52px] md:text-[42px] text-[33px] text-[#22281E] relative">Contact Us</h1>
        ...
        <div class="grid lg:grid-cols-2 gap-10">
            <div class="">
                ...
                <a href="" class="inline-flex text-[#696981]">
                    ...
                    <a href="mailto:math-calculator@gmail.com">math-calculator@gmail.com</a>
                </a>
            ...
            <div class="">
                <form action="" method="post" class="grid gap-3">
                    ...
                    <button type="submit" class="w-full py-2 outline-none rounded px-10 text-lg bg-[#000000] text-white">Send</button>
                </form>
                @if (session('success'))
